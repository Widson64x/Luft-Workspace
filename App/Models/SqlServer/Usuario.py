...
class Usuario(Base, UserMixin): 
    ...
    grupo = relationship("UsuarioGrupo", foreign_keys=[codigo_usuariogrupo])

    @property
    def Nome_UsuarioGrupo(self):
        return self.grupo.Sigla_UsuarioGrupo if self.grupo else None
